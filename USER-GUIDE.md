...
Now you remove `app/code/Mageplaza/Gdpr` folder. In this step, you can copy override Gdpr folder but this may cause of compilation issue. That why you should remove it.
